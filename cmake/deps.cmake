...
if(NETWORK_ENABLED)
  if(IOS)
    ...
    set(CPR_FORCE_MBEDTLS_BACKEND OFF CACHE BOOL "" FORCE)
...
function(_yataidon_collect_targets outvar dir)
  ...
  foreach(_subdir ${_subdirs})
    _yataidon_collect_targets(_subresult "${_subdir}")
    list(APPEND _result ${_subresult})
  endforeach()
...
_yataidon_collect_targets(_dep_targets "${CMAKE_SOURCE_DIR}")
foreach(_tgt ${_dep_targets})
  get_target_property(_tgt_type ${_tgt} TYPE)
  if(_tgt_type STREQUAL "INTERFACE_LIBRARY" OR _tgt_type STREQUAL "UTILITY")
    continue()
  endif()
  if(MSVC)
