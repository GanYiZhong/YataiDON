...
// ROUND 18 (r18-misc): `clear_progress` (5th Lua arg) is the clear/norma line as a
// fraction of the bar. The arcade's background-dancer count is floor(2*gauge/clear + 3)
// clamped to [3,5] (EnsoGraphicDancer::Process), so the skin needs the clear point, not
// just the progress. Additive: a skin that ignores it is unaffected.
